...
public class PhotoPrinterTest {
	...
	{
		//Mock the class that contain method of getRequest that will return the array of orders
		...
		print.queueRequest();
		//Assert equals the array of orders return from getRequest with Actual array of orders
		assertEquals(orderMock.getRequest(),getOrderMock.printingOrders);
		//Verify array of orders used for updateRequest method with actual array of orders
